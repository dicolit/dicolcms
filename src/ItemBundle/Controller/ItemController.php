...
class ItemController extends Controller
{
  ...
  public function itemAction(Request $request)
  {
    ...
    return $this->render('@front/item/item_page.html.twig', array(
  ...
  /**
   * @Route("/item/{id}", name="item_detail_page")
   */
  public function itemDetailAction(Request $request)
  {
    return $this->render('@front/item/item_detail_page.html.twig', array(
